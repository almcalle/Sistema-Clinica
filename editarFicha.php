      ...
      <div class="content-wrapper">
        ...
        <div class="row">
         ...
         <div class="panel-body">
         		 <form role="form" method="POST" action="php/editarFicha.php" enctype="multipart/form-data" id="editarFicha">
          	<!--MENU DE OPCIONES-->
          	<div class="col-lg-12">
          		...
          		<div class="box box-warning">
	    			...
	    			<div class="box-body">
	    				<div class="form-group"><!--Numero de identidad-->
							...
							<input class="form-control" maxlength="13" required="required" type="number" name="identidad" placeholder="" value="<?php echo $Ficha['identidad']; ?>" onkeypress="return soloNumero(event)"/>
	    				</div>
	    				<div class="form-group">
	    					<label for="nombre">* Nombre de niño(a)</label>
	    					<input  type="text" value="<?php echo $Ficha['nombre']; ?>"  style="text-transform:uppercase;" onBlur="javascript:this.value=this.value.toUpperCase();" name="nombre" maxlength="40" required="required" class="form-control"/>
	    				</div>
	    				<div class="form-group"><!--Fecha de nacimiento y edad-->
	    				<div class="col-xs-6">
	    					<label for="fecha">* Fecha de nacimiento</label>
	    					<div class="input-group">
                  			<input onBlur="getAge()" value="<?php echo $Ficha['fecha_nacimiento']; ?>"  class="form-control" type="text" name="fecha" id="fecha" required="required"/>
                  			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  			</div>
	    				</div>
	    				<div class="col-xs-6">
	    					<label for="edad">* Edad</label>
                <input readonly="readonly" type="number" min="1" max="99" required="required" id="edad" name="edad" class="form-control" value="<?php echo $Ficha['edad']; ?>"/>
	    				</div>
	    				</div>
	    				<div class="form-group"><!--Responsable-->
	    					<label for="responsable">Nombre del responsable</label>
	    					<input type="text" value="<?php echo $Ficha['responsable']; ?>" maxlength="40" onBlur="javascript:this.value=this.value.toUpperCase();" style="text-transform: uppercase;" required="required" name="responsable" class="form-control" />
	    				</div>
              <div class="form-group"><!--Responsable-->
	    					<label for="contacto_responsable">Contacto del responsable</label>
	    					<input type="text" value="<?php echo $Ficha['contacto_responsable']; ?>" maxlength="40" onBlur="javascript:this.value=this.value.toUpperCase();" style="text-transform: uppercase;" required="required" name="contacto_responsable" class="form-control" />
	    				</div>
	    				<div class="form-group">
	    					<div class="col-xs-6">
	    						<label for="grado">Grado</label>
	    						<select value="<?php echo $Ficha['grado']; ?>" name="grado" class="form-control">
	    					...
	    					<div class="col-xs-6">
	    						...
	    						<input  value="<?php echo $Ficha['seccion']; ?>" type="number" min="1" max="99" required="required" name="seccion" class="form-control"/>
	    					</div>
	    				</div>
	    			</div>
	    		</div>
...
function soloNumero(e){
    ...
    function limpiar() {
    document.getElementById("editarFicha").reset();
  }
