...
?>    
      ...
      <div class="content-wrapper">
        ...
        <h1>
        Consulta de Examenes Fisicos
        <small></small>
        </h1>
        <ol class="breadcrumb">
        <li><a href="menu.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li>Ficha de Examen Físico</li>
        <li class="active">Consulta de Examen Físico</li>
        </ol>
        </section>
        ...
        $registro = mysql_query("SELECT * FROM examen ") or die(mysql_error());
