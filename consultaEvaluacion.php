...
?>
      ...
      <div class="content-wrapper">
        ...
        <li>Fichade Evaluación Médica</li>
        <li class="active">Consulta de Evaluación Médica</li>
        </ol>
        </section>
        ...
        $registro = mysql_query("SELECT * FROM evaluaciones ") or die(mysql_error());
                ...
                <td>'.$registro2['id'].'</td>
                  ...
                  <td>'.$nombre['nombre'].'</td>
                   <td>'.$registro2['fecha'].'</td>
                        <td><a href="javascript:detalleEvaluacion('.$registro2['id'].');" class="glyphicon glyphicon-search" data-toggle="tooltip" title="Ver Detalle"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:borrarEvaluacion('.$registro2['id'].');" class="fa fa-trash" data-toggle="tooltip" title="borrar Evaluación"></a></td>
                   </tr>';
      }
        echo '</tbody></table>';
...
function detalleEvaluacion(id){
    var url = '/php/detalleEvaluacion.php';
    if(!id){
        }
        else{
        $.ajax({
