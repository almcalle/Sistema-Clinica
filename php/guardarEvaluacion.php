...
if(isset ($_POST['identidad'])){
    ...
    mysql_query("insert into evaluaciones(identidad,estrabismo,perdida_auditiva,transtorno_fonacion,pediculosis,sarna,anemia,violencia,problemas_personalidad,problemas_aprendizaje,uso_drogas,fecha) values('".$identidad."','".$estrabismo."','".$perdida_auditiva."','".$transtorno_fonacion."','".$pediculosis."','".$sarna."','".$anemia."','".$violencia."','".$problemas_personalidad."','".$problemas_aprendizaje."','".$uso_drogas."', CURDATE())") or die(mysql_error());
