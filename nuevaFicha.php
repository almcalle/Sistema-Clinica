          		...
          		<div class="box box-warning">
	    			...
	    			<div class="box-body">
	    				...
	    				<div class="form-group">
	    					...
	    					<input  type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" name="nombre" maxlength="40" required="required" class="form-control"/>
	    				</div>
	    				<div class="form-group"><!--Fecha de nacimiento y edad-->
	    				<div class="col-xs-6">
	    					<label for="fecha">* Fecha de nacimiento</label>
	    					<div class="input-group">
                  			<input class="form-control" type="text" name="fecha" id="fecha" required="required"/>
          		...
          		<div class="box box-warning">
	    			...
	    			<div class="box-body">
	    				...
	    				<label for="form-group">Dirección</label>
	    					<input name="direccion" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" maxlength="60" class="form-control" style="text-transform:uppercase;"/>
	    				</div>
	    				<div class="form-group">
